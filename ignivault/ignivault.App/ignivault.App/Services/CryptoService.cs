...
namespace ignivault.App.Services
{
    ...
    public class CryptoService : ICryptoService
    {
        ...
        //    if (result == null)
        //    {
        //        throw new CryptographicException("Encryption failed in JavaScript.");
        //    }

        //    var encryptedData = result.Value.GetProperty("encryptedData").GetBytesFromBase64();
        //    var returnedIv = result.Value.GetProperty("iv").GetBytesFromBase64();
        //    Console.WriteLine("HERE 1");
        //    return new EncryptionResult(encryptedData, returnedIv);
        //}
        ...
        public async Task<EncryptionResult?> EncryptAsync<T>(T data, byte[] salt, string masterPassword)
        {
            var dataBytes = JsonSerializer.SerializeToUtf8Bytes(data); // Serializes to JSON
