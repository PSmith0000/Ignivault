...
namespace ignivault.WebAPI.Migrations
{
    /// <inheritdoc />
    public partial class ApiSchema : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    KeySalt = table.Column<byte[]>(type: "varbinary(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsBlobStored = table.Column<bool>(type: "bit", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_VaultItems", x => x.ItemId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_StoredBlobs", x => x.BlobId);
                    table.ForeignKey(
                        name: "FK_StoredBlobs_VaultItems_VaultItemId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StoredBlobs_VaultItemId",
                table: "StoredBlobs",
                column: "VaultItemId",
                unique: true);
